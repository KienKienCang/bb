...
<html>
<head>
    <title>Mainboard - KKC Store</title>
    <link rel="stylesheet" type="text/css" href="stylemainboard.css">
    <style>
        .grid {
            display: flex;
            flex-wrap: wrap;
...
<body>
    ...
    <section class="sort-options">
        <form method="get" action="mainboard.jsp">
        ...
        <div class="grid">
            <% 
                ...
                try {
                    ...
                    String query = "SELECT id, name, price, image_url FROM product WHERE category_id = 1 " + orderBy;
