...
<html>
<head>
    <title>PC Case - KKC Store</title>
    <link rel="stylesheet" type="text/css" href="stylecase.css">
    <style>
        .grid {
            display: flex;
            flex-wrap: wrap;
...
<body>
    ...
    <section class="sort-options">
        <form method="get" action="case.jsp">
        ...
        <div class="grid">
            <% 
                ...
                try {
                    ...
                    String query = "SELECT id, name, price, image_url FROM product WHERE category_id = 4 " + orderBy;
