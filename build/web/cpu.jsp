...
<html>
<head>
    <title>CPU - KKC Store</title>
    <link rel="stylesheet" type="text/css" href="stylecpu.css">
    <style>
        .grid {
            display: flex;
            flex-wrap: wrap;
...
<body>
    ...
    <section class="sort-options">
        <form method="get" action="cpu.jsp">
        ...
        <div class="grid">
            <% 
                ...
                try {
                    ...
                    String query = "SELECT id, name, price, image_url FROM product WHERE category_id = 2 " + orderBy;
